...
type ConfigID =
  ...
  | 'PinPoint.Enable'
  | 'PinPoint.ConfigurationSetName'
  | 'PinPoint.Context'
  | 'PinPoint.DestinationCountryParameters'
  | 'PinPoint.Keyword'
  | 'PinPoint.MaxPrice'
  | 'PinPoint.OriginationIdentity'
  | 'PinPoint.ProtectConfigurationId'
  | 'PinPoint.TimeToLive'
  | 'PinPoint.AwsAccessKeyId'
  | 'PinPoint.AwsSecretAccessKey'
  | 'PinPoint.AwsSessionToken'
  | 'SMTP.Enable'
  | 'SMTP.From'
  | 'SMTP.Address'
  | 'SMTP.DisableTLS'
